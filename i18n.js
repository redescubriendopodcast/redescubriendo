...
window.I18N = {
  es: {
    ...
    "about.pillar5.title":     "El despertar institucional de 2026: la web oficial y el Disclosure Forum",
    "about.pillar5.body":      "2026 marca un cambio estructural en dos frentes. Por un lado, el ejecutivo de EE.UU. abre un portal oficial de divulgación UAP (war.gov/UFO), reconociendo por primera vez el fenómeno como categoría legítima de comunicación pública. Por otro, el <strong>Disclosure Forum</strong> reúne durante más de siete horas, en la histórica Sala Kennedy del Senado, a físicos, historiadores, legisladores e inteligencia: la señal de que el tema ha dejado de ser marginal para <em>institucionalizarse</em>. Dos caras del mismo giro histórico.",
  ...
  en: {
    ...
    "about.pillar5.title":     "The 2026 Institutional Awakening: the Official Site and the Disclosure Forum",
    "about.pillar5.body":      "2026 marks a structural shift on two fronts. On one hand, the U.S. executive opens an official UAP disclosure portal (war.gov/UFO), recognizing for the first time the phenomenon as a legitimate category of public communication. On the other, the <strong>Disclosure Forum</strong> gathers physicists, historians, legislators and intelligence professionals for more than seven hours in the historic Kennedy Caucus Room of the Senate: a sign that the subject has moved from the margins to <em>institutionalization</em>. Two faces of the same historic turn.",
